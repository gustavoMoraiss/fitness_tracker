...
import com.teste.fitnesstracker.R;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mainItems.add(new MainItem(1, R.drawable.lightbulb, R.string.label_imc, Color.LTGRAY));
		mainItems.add(new MainItem(2, R.drawable.heart, R.string.label_tmb, Color.LTGRAY));
